  ...
  return (
    <Paper elevation={3} sx={{ pt: 2, px: 2, mb: 5 }}>
      <Card sx={isMedium ? { display: "block" } : { display: "flex", flexWrap: "wrap" }}>
          <LeftImgCard wth="50%" img="code/ChatApp.png" header="ChatApp (JavaScript, React)" desc="A chatting application that runs off a node.js server with a React Front-End (School Project)&#10; 
          ...
          <LeftImgCard wth="50%" img="code/floorMe.jpg" header="Floor Me (C#, Windows Forms)" desc="A management application for a flooring company&#10; 
          ...
          <LeftImgCard wth="50%" img="code/infoCasestudy.jpg" header="Online RAM Shop (ASP.NET 3.0)" desc="A Full-Stack Website project that uses ASP.Net 3.0, C#, and Vue (School Project)
          &#10;&#10;This web application allows a user to Register an account, Log in, and create fake orders.">
          </LeftImgCard>
          <LeftImgCard wth="50%" img="code/BakeMate.jpg" header="BakeMate (Android, Java, Kotlin)" desc="A mobile baking companion app that assists the user with common baking problems such as unit conversions (grams to imperial), multiple timers, and a shopping list.">
          </LeftImgCard>
          <LeftImgCard wth="50%" img="code/stk.jpg" header="" list={[ <Typography variant={"subtitle1"} align="left">A Python program that utilizes tkinter, and several other modules to accomplish different tasks.</Typography>,
